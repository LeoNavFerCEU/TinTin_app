...
public class StudentDto {
  ...
  public StudentDto hoursWorked(@javax.annotation.Nullable String hoursWorked) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("hoursWorked") != null && !jsonObj.get("hoursWorked").isJsonNull()) && !jsonObj.get("hoursWorked").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `hoursWorked` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hoursWorked").toString()));
      }
  }
